// Importar jsdom solo si estamos en un entorno de Node.js
...
// Ahora puedes usar `window` y `document` tanto en Node.js como en el navegador
if (typeof window !== "undefined") {
...
// Las partes específicas del navegador se envuelven con una comprobación if (typeof window !== "undefined")
// para asegurarse de que solo se ejecuten en entornos de navegador.
// Las otras partes del código pueden ejecutarse tanto en Node.js como en el navegador sin cambios.
// Asegúrate de envolver cualquier código que dependa del objeto window dentro de esta verificación.
// De lo contrario, obtendrás errores como "window is not defined" cuando se ejecute en Node.js.
